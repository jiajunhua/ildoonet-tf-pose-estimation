    ...
    def setup(self):
        ...
        with tf.variable_scope(None, 'MobilenetV1'):
            (self.feed('image')
             ...
             .separable_conv(3, 3, depth(128), 2, name='Conv2d_2', trainable=self.trainable)
             ...
             .separable_conv(3, 3, depth(512), 1, name='Conv2d_6', trainable=self.trainable)    # modified channel
             .separable_conv(3, 3, depth(512), 1, name='Conv2d_7', trainable=self.trainable)
             .separable_conv(3, 3, depth(512), 1, name='Conv2d_8', trainable=self.trainable)
