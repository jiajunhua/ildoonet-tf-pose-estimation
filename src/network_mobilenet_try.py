...
class MobilenetNetworkTry(network_base.BaseNetwork):
    ...
    def setup(self):
        ...
        (self.feed('image')
         ...
         .convb(3, 3, depth(32), 2, name='MobilenetV1/Conv2d_0')
         .separable_conv(3, 3, depth(64), 2, name='MobilenetV1/Conv2d_1')
         .separable_conv(3, 3, depth(128), 2, name='MobilenetV1/Conv2d_2')
         .separable_conv(3, 3, depth(128), 1, name='MobilenetV1/Conv2d_3')
         .separable_conv(3, 3, depth(256), 1, name='MobilenetV1/Conv2d_4')
         .separable_conv(3, 3, depth(256), 1, name='MobilenetV1/Conv2d_5')
         .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_6')
         .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_7')
         .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_8')
         .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_9')
         .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_10')
         # .separable_conv(3, 3, depth(512), 1, name='MobilenetV1/Conv2d_11')
         # .separable_conv(3, 3, depth(1024), 2, name='MobilenetV1/Conv2d_12')
         # .separable_conv(3, 3, depth(1024), 1, name='MobilenetV1/Conv2d_13')
         )

        feature_lv = 'MobilenetV1/Conv2d_10'
        prefix = 'MConv_Stage1'
        (self.feed(feature_lv)
         ...
         .convb(1, 1, 38, 1, relu=False, name=prefix + '_L1_5'))
        ...
        (self.feed(feature_lv)
         ...
         .convb(1, 1, 19, 1, relu=False, name=prefix + '_L2_5'))
